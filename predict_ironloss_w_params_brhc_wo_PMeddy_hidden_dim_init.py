...
def result_name(modelname):
    return f'pred_ironloss_brhc_{modelname}_w_params_hidden_dim_init'
# ==========================================================
...
def main(modelname, typename, pathmodel=None, hidden_dim_init_list=None):
    ...
    for hidden_dim_init in hidden_dim_init_list:
        params['hidden_dim_init'] = hidden_dim_init
        for t in range(params['times']):
            ...
            for epoch in range(epochs):
                ...
                if (epoch+1) % save_every == 0: save_model(model.state_dict(), epoch+1, t, hidden_dim_init)
            save_result(results, epoch+1, t, hidden_dim_init)
...
if __name__=="__main__":
    ...
    print(type(args.hidden_dim_init_list), args.hidden_dim_init_list)
    main(args.modelname, args.typename, args.pathmodel, args.hidden_dim_init_list)
