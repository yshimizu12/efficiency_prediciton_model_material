...
for PM_mat in PM_material_list:
    for PM_temp in PM_TEMP_list:
        ...
        if show_figure:
            ...
            ax.plot([140,330],[PA[0]*alpha,PA[0]*alpha],'b--', linewidth=1)
            ax.plot([140,330],[PA[0]*alpha*beta,PA[0]*alpha*beta],'b--', linewidth=1)
            ax.plot([PA[0]*alpha,PA[0]*alpha],[140,330],'b--', linewidth=1)
            ax.plot([PA[0]*alpha*beta,PA[0]*alpha*beta],[140,330],'b--', linewidth=1)
